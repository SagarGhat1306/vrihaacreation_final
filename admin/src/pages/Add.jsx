...
const Add = ({token}) => {
  ...
  <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3 '>
    <div>
      <p className='mb-2'>uplode Image</p>
    ...
    <div className='w-full'>
     ...
     <div className='w-full'>
      ...
      <input onChange={(e)=>setDescription(e.target.value)} className='w-full max-w-[500px] px-3 py-2 ' type='text' placeholder='write content here' required/>
    </div>

    <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
      <div>  
        <p className='mb-2'>Product Catagory</p>
      ...
      <div>
        ...
        <input onChange={(e)=>setPrice(e.target.value)} className = "w-full px-3 py-2 sm:w-[120px ]" type = "number" placeholder='10'/>
      </div>
    ...
    <button  type='submit' className='w-28 py-2 px-3 text-white bg-black'>ADD </button>
  </form>
  )
}
